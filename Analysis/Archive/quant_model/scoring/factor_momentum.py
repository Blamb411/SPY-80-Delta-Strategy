...
========================
Scores stocks on price momentum: 3-month, 6-month, 12-month returns.
Higher is better (sector-relative).
"""
...
def score_momentum(symbols: List[str], as_of_date: str,
    ...
    metric_data = {}
    for metric_name, weight, higher_is_better in config.MOMENTUM_SUB_FACTORS:
        rows = conn.execute(
